...
LEFT OUTER JOIN dba.LEGAL_DLS_LOC       ON WELL.UWI = LEGAL_DLS_LOC.UWI and WELL.LEGAL_SURVEY_TYPE = LEGAL_DLS_LOC.LOCATION_TYPE ORDER BY "Well ID";OUTPUT TO D:\Samples\GXDBRegression\GXDBRegression\Results\Well\WellHeaderAndLocation.sql_1.xml FORMAT XML
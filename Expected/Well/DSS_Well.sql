...
case when a.WELL_NAME is not null then WELL_NAME + ' ' + a.WELL_NUMBER else a.UWI end as NAME,
...
b.GX_BASE_LONGITUDE as bh_longitude from
DBA.WELL as a, DBA.WELL_DIR_SRVY as b
WHERE a.UWI = b.UWI
ORDER BY PID;OUTPUT TO D:\Samples\GXDBRegression\GXDBRegression\Results\Well\DSS_Well.sql_1.xml FORMAT XML
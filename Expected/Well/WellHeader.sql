...
WELL.GX_PERCENT_ALLOCATION      AS "Percent Allocation",
WELL.ORIGINAL_OPERATOR          AS "Original Operator",
WELL.GGX_INTERNAL_STATUS        AS "Internal Status",
WELL.GX_WSN             AS "WSN",
WELL.GX_PROPOSED_FLAG           As "Proposed"
FROM WELL ORDER BY "WELL ID";OUTPUT TO D:\Samples\GXDBRegression\GXDBRegression\Results\Well\WellHeader.sql_1.xml FORMAT XML